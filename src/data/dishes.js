...
const darginskijPoster = B + 'images/darginskij-hinkal.png'
const avarskijPoster = B + 'images/avarskij-hinkal.png'
const zhizhiPoster = B + 'images/zhizhi-galnash.png'

const girosPoster = B + 'images/giros-poster.png'
const burgerPoster = B + 'images/burger-poster.png'
const sendvichPoster = B + 'images/sendvich-poster.png'

const atlantidaPoster = B + 'images/atlantida-poster.png'
const bobPoster = B + 'images/bob-poster.png'
const brutalnyjPoster = B + 'images/brutalnyj-poster.png'
const brutalnyjVideo = B + 'videos/brutalnyj.mp4'
const atlantidaVideo = B + 'videos/atlantida.mp4'
const bobVideo = B + 'videos/bob.mp4'
const buchoPoster = B + 'images/bucho-poster.png'
const vdokhnoveniePoster = B + 'images/vdokhnovenie-poster.png'
const vesennijPoster = B + 'images/vesennij-poster.png'
const vinegretPoster = B + 'images/vinegret-poster.png'
const vinegretGulliverPoster = B + 'images/vinegret-gulliver-poster.png'
const vitaminnyjPoster = B + 'images/vitaminnyj-poster.png'
const derevenskijPoster = B + 'images/derevenskij-poster.png'
const kleopatraPoster = B + 'images/kleopatra-poster.png'
const koulSloPoster = B + 'images/koul-slo-poster.png'
const lesnojPoster = B + 'images/lesnoj-poster.png'
const malahitPoster = B + 'images/malahit-poster.png'
const morkovKorejskayaPoster = B + 'images/morkov-korejskaya-poster.png'
const ovoshhnojSalatPoster = B + 'images/ovoshhnoj-salat-poster.png'
const redkaKabardinskijPoster = B + 'images/redka-kabardinskij-poster.png'
const svekolnyjPoster = B + 'images/svekolnyj-poster.png'
const stolichnyjPoster = B + 'images/stolichnyj-poster.png'
const tashkentPoster = B + 'images/tashkent-poster.png'

// Супы
const borshchPoster = B + 'images/borshch-poster.png'
const gorohovyjPoster = B + 'images/gorohovyj-poster.png'
const lapshaGribnayaPoster = B + 'images/lapsha-gribnaya-poster.png'
const solyankaMyasnayaPoster = B + 'images/solyanka-myasnaya-poster.png'
const okroshkaPoster = B + 'images/okroshka-poster.png'
const rassolnikPoster = B + 'images/rassolnik-poster.png'
const svekolnikPoster = B + 'images/svekolnik-poster.png'
const ukhaPoster = B + 'images/ukha-poster.png'
const kharchoPoster = B + 'images/kharcho-poster.png'
const shhiZelenyePoster = B + 'images/shhi-zelenye-poster.png'
const shhiKvashennyePoster = B + 'images/shhi-kvashennye-poster.png'

// Горячие блюда
const pelmeniPoster = B + 'images/pelmeni-poster.png'
const makaronyFlotskiePoster = B + 'images/makarony-flotskie-poster.png'
const ovoshhnoeRaguPoster = B + 'images/ovoshhnoe-ragu-poster.png'
const odzhakhuriPoster = B + 'images/odzhakhuri-poster.png'
const shnitselIndjejkaPoster = B + 'images/shnitsel-indjejka-poster.png'
const chashushuliPoster = B + 'images/chashushuli-poster.png'
const rybaMilanskiPoster = B + 'images/ryba-milanski-poster.png'
const kazanKebabPoster = B + 'images/kazan-kebab-poster.png'
const pastaTsyplyonokPoster = B + 'images/pasta-tsyplyonok-poster.png'
const pastaMintajPoster = B + 'images/pasta-mintaj-poster.png'
const kotletyPoster = B + 'images/kotlety-poster.png'
const pastaBolonezePoster = B + 'images/pasta-boloneze-poster.png'
const pastaKarbonaraPoster = B + 'images/pasta-karbonara-poster.png'
const gulyashPoster = B + 'images/gulyash-poster.png'
const mintajSmetanaPoster = B + 'images/mintaj-smetana-poster.png'
const mintajTomatPoster = B + 'images/mintaj-tomat-poster.png'
const kuricaZapechennayaPoster = B + 'images/kurica-zapechennaya-poster.png'
const tefteliPoster = B + 'images/tefteli-poster.png'
const myasoStroganovskiPoster = B + 'images/myaso-stroganovski-poster.png'
const pastaKolbaskiPoster = B + 'images/pasta-kolbaski-poster.png'
const krylyshkiMedPoster = B + 'images/krylyshki-med-poster.png'
const gribnoeLukoshkoPoster = B + 'images/gribnoe-lukoshko-poster.png'
const kartofelGribyPoster = B + 'images/kartofel-griby-poster.png'
const mintajOvoshhiPoster = B + 'images/mintaj-ovoshhi-poster.png'
const lenivyeGolubtsyPoster = B + 'images/lenivye-golubtsy-poster.png'
const solyankaKapustaPoster = B + 'images/solyanka-kapusta-poster.png'

// Десерты
const keksShokoladPoster = B + 'images/keks-shokolad-poster.png'
const medovikPoster = B + 'images/medovik-poster.png'

// Завтраки
const kashaOvsyankaPoster = B + 'images/kasha-ovsyanka-poster.png'
const omletPoster = B + 'images/omlet-poster.png'
const tvorochnayaZapekankaPoster = B + 'images/tvorochnaya-zapekanka-poster.png'

// Новые салаты
const caesarPoster = B + 'images/caesar-poster.png'

// Новые супы
const lapshaKurinayaPoster = B + 'images/lapsha-kurinaya-poster.png'
const minestronePoster = B + 'images/minestrone-poster.png'
const risovyjFrikadelkiPoster = B + 'images/risovyj-frikadelki-poster.png'
const fasolevyjPoster = B + 'images/fasolevyj-poster.png'
const chechevichnyjPoster = B + 'images/chechevichnyj-poster.png'
const chuchvaraPoster = B + 'images/chuchvara-poster.png'
const mastavaPoster = B + 'images/mastava-poster.png'

// Новые горячие блюда
const myasoNePoFranczuzskiPoster = B + 'images/myaso-ne-po-franczuzski-poster.png'
const zharkoePoster = B + 'images/zharkoe-poster.png'
const mantyPoster = B + 'images/manty-poster.png'
const myasnyeEzhikiPoster = B + 'images/myasnye-ezhiki-poster.png'

// Новые завтраки
const kashaRisovayaPoster = B + 'images/kasha-risovaya-poster.png'
const omletVetchinaPoster = B + 'images/omlet-vetchina-poster.png'
const otvarnyeYajcaPoster = B + 'images/otvarnye-yajca-poster.png'
const oladiPoster = B + 'images/oladi-poster.png'
const syrnikiPoster = B + 'images/syrniki-poster.png'

// Новые десерты/напитки
const keksKlassicheskijPoster = B + 'images/keks-klassicheskij-poster.png'
const blinchikiPoster = B + 'images/blinchiki-poster.png'
const napitokRozaPoster = B + 'images/napitok-roza-poster.png'
const kompotPoster = B + 'images/kompot-poster.png'
