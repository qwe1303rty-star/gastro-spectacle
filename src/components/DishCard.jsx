      ...
      <div className="bg-ink/90 px-5 md:px-6 pt-4 pb-5 md:pb-6">
        ...
        <div className="mt-3 pt-3 border-t border-white/10" onClick={(e) => e.stopPropagation()}>
          {!inCart ? (
            <button
              onClick={handleAdd}
              className="w-full flex items-center justify-center gap-2 py-2.5 rounded-lg text-[12px] tracking-wider uppercase font-light bg-white/5 text-pearl/60 hover:bg-white/10 hover:text-pearl transition-all duration-300"
            >
            ...
            <div className="flex items-center justify-between bg-gold rounded-lg overflow-hidden">
              <button
